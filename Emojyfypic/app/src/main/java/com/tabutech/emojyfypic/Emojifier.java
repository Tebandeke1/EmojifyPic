...
public class Emojifier {
    ...
    public static Bitmap  detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        Timber.d(TAG,"detectFaces: number of faces = " + faces.size());
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Timber.d(TAG,"whichEmoji: smilingProb = " + face.getIsSmilingProbability());
        Timber.d(TAG,"whichEmoji: leftEyeOpenProb = "
                + face.getIsLeftEyeOpenProbability());
        Timber.d(TAG,"whichEmoji: rightEyeOpenProb = "
        ...
        Timber.d(TAG,"whichEmoji: " + emoji.name());
